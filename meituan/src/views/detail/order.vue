  ...
  <div>
    <div class="order-box">
      <div class="menu-box" ref="menuBox">
        <ul>
          <li class="menu-list" v-for="(item, index) in prodList" :key="index" :class="{'active':currentIndex==index}" @click="changeMenu(index)">
            {{ item.name }}
          </li>
        </ul>
      </div>
      <div class="prod-box" ref="proBox">
        <ul>
          <li class="cate-list" v-for="(item, typeIndex) in prodList" :key="typeIndex">
            ...
            <ul>
              <li class="prod-list" v-for="(prod,index) in item.content" :key="index">
                ...
                <div class="add-cart-container">
                    <add-card :type="typeIndex" :index="index"></add-card>
                </div>
              </li>
            </ul>
          </li>
